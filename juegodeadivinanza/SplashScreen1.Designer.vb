...
Partial Class SplashScreen1
    ...
    Private Sub InitializeComponent()
        ...
        Copyright.ForeColor = Color.Thistle
        Copyright.Location = New Point(3, 39)
        Copyright.Name = "Copyright"
        Copyright.Size = New Size(241, 40)
        Copyright.TabIndex = 2
        Copyright.Text = "Copyright Kupi INC"
        ' 
        ' ApplicationTitle
        ' 
        ApplicationTitle.Anchor = AnchorStyles.None
        ApplicationTitle.BackColor = Color.Transparent
        ApplicationTitle.Font = New Font("Microsoft Sans Serif", 18F, FontStyle.Bold, GraphicsUnit.Point)
        ApplicationTitle.ForeColor = SystemColors.ControlLightLight
        ApplicationTitle.Location = New Point(255, 36)
        ApplicationTitle.Name = "ApplicationTitle"
        ApplicationTitle.Size = New Size(229, 146)
        ApplicationTitle.TabIndex = 0
        ApplicationTitle.Text = "JUEGO DE MEMORIA CLICK BUSCAR"
        ...
        PictureBox1.Size = New Size(237, 212)
